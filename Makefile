...
# Tests
TESTS = test_io test_io_v2 test_string test_file test_memory test_screen_buffer test_viewports test_screen_wrap test_debug test_io_color test_network test_serial
